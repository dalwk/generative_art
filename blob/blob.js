...
function Blob(x, y, radius, numPointMasses)
{
  ...
  this.drawEyeStyle = 1;
  this.selected = false;
  this.randColorStroke = "#" + (Math.random()*0xFFFFFF<<0).toString(16);
  this.randColorFill = "#" + (Math.random()*0xFFFFFF<<0).toString(16);
  ...
  this.drawBody = function(ctx, scaleFactor)
  {
    ...
    ctx.strokeStyle = this.randColorStroke;
    ...
    {
      ctx.fillStyle = this.randColorFill;
    }
    ctx.lineWidth = 10;
    ctx.beginPath();
